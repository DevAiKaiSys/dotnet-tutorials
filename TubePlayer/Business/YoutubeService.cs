...
{
    public async Task<YoutubeVideoSet> SearchVideos(string searchQuery, string nextPageToken, uint maxResult,
    ...
    public async Task<string?> GetVideoSourceUrl(string videoId, CancellationToken ct)
    {
        ...
        var streamWithHighestVideoQuality = streamData.Content?.StreamingData?
            .Formats?
