                                                            ...
                                                            (
                                                                new Border()
                                                                    ...
                                                                    (
                                                                        new Image()
                                                                            .Source(() =>
                                                                                youtubeVideo.Details.Snippet?.Thumbnails
                                                                                    ?.Medium?.Url!)
                                                                            .Stretch(Stretch.UniformToFill)
                                                                    ),
                                                                new AutoLayout()
                                                                    ...
                                                                    (
                                                                        ...
                                                                        new AutoLayout()
                                                                            .PrimaryAxisAlignment(AutoLayoutAlignment
                                                                                .Center)
                                                                            .AutoLayout(
                                                                                primaryAlignment:
                                                                        ...
                                                                        new Button()
                                                                            .Foreground(Theme.Brushes.OnSurface.Variant
                                                                                .Default)
                                                                            ...
                                                                            (
                                                                                new PathIcon()
                                                                                    .Data(StaticResource.Get<Geometry>(
                                                                                        "Icon_Chevron_Right"))
                                                                                    .Foreground(Theme.Brushes.OnSurface
                                                                                        .Variant.Default)
                                                                            )
